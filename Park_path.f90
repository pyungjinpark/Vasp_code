!123456     
      ...
      real :: Pi
      integer :: npath
      real, allocatable :: band1(:,:), band2(:,:), band3(:,:)
...
!123456
      ...
      allocate (band1(npath,1), band2(npath,2), band3(npath,3))

      do a = 1, npath
          read(1,*) band1(a,1), band2(a,2), band3(a,3)
          write(6,*) band1(a,1), band1(a,2), band3(a,3)
      enddo
        do i =1,nk
           read(15,*)
      ...
      do i=1,npath
        do j=1,nk
      if(xrk(j,1).eq.band1(i,1).and.xrk(j,2).eq.band2(i,2).and.xrk(j,3).eq.band3(i,3)) then
                  write(6,*) kval(j)
      endif
        enddo
      enddo
 ...
 118  format(f14.7,3x,f14.7)
      ...
      do a = 1, npath
          read(1,*) band1(a,1), band2(a,2), band3(a,3)
          write(6,*) band1(a,1), band2(a,2), band3(a,3)
      enddo
